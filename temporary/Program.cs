...
namespace temporary
{
    class Program
    {
        ...
        {
            using (UnitOfWork ctx = new UnitOfWork(new InventoryManagerEntities()))
            {
                //Console.WriteLine(ctx.Products.GetAll().ToString());
                try
                {
                    ...
                    byte[] bytes = ImageToByte(Resources.phone1);
                    p1.picture = bytes;
                    p2.picture = ImageToByte(Resources.phone2);
                    p3.picture = ImageToByte(Resources.phone3);
                    p4.picture = ImageToByte(Resources.phone4);
                    ...
                    Store s5 = new Store(4, "Leonardo", "Decaprio", "His Store", "0124578952", null, "phones, ssomthing something");

                    s1.picture = ImageToByte(Resources.person1);
                    s2.picture = ImageToByte(Resources.person2);
                    s3.picture = ImageToByte(Resources.person3);
                    s4.picture = ImageToByte(Resources.person4);
